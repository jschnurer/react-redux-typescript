...
const Welcome: React.FC = () =>
  <>
    ...
    <p>
      For a backend API, it uses <a href="https://my-json-server.typicode.com/">My JSON Server</a> for a fake datasource. It doesn't persist PUTs, POSTs, or DELETEs so any changes made won't persist if you reload the page.
    </p>
    <p>
